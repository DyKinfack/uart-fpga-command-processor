# UART FPGA Command Processor (Verilog)
...
This project implements a complete UART-based command processing system on FPGA.
Commands are received via UART, decoded and executed by an ALU.
